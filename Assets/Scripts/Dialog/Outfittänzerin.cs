...
public class OutfitTänzerin : NPC
{
    public override void Interact()
    {
        ...
        initialDialogLines = new string[] {"Ugh, it's so frustrating.",  "I can't even start my routine properly because the music keeps skipping.", "The missing lyrics are throwing off my entire performance." };
